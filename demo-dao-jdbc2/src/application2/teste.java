...
// System.out.println("\n=== TEST 1: usuarios Insert ===");
// Usuarios newUsuarios = new Usuarios(0, "Diogo", "123456", "diogo1934@gmail.com","99999-9999", 5);
// usuariosDao.insert(newUsuarios);
// System.out.println("Inserted! New id = " + newUsuarios.getId());

// System.out.println("=== TEST 2: usuarios findById ===");
// Usuarios usuarios = usuariosDao.findById(3);
// System.out.println(usuarios);

// System.out.println("\n=== TEST 3: usuarios UPDATE ===");
// usuarios = usuariosDao.findById(3);
// usuarios.setSenha("1234");
// usuariosDao.update(usuarios);
// System.out.println("Update completed");

// System.out.println("\n=== TEST 4: usuarios Delete ===");
